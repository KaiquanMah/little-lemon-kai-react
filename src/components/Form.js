...
const schema = yup.object({
  ...
  telephone: yup
    ...
    .matches(/^\d{4}\s\d{4}$/, "Phone number must match the form 1234 5678"),
  guests: yup
    .number()
        ...
        <div className="field occasion">
          ...
          <div className="options">
            <select name="occasion" {...register("occasion")}>
              <option value="select">Select special occasion</option>
              <option value="birthday">Birthday</option>
              <option value="workcelebration">Workplace Celebration</option>
            </select>
          </div>
        </div>
